...
class DiscountsControllerTest < ActionController::TestCase
  ...
  test "should create discount" do
    assert_difference('Discount.count') do
      post :create, discount: { company_id: @discount.company_id, default: @discount.default, description: @discount.description, discount: @discount.discount }
    end
  ...
  test "should update discount" do
    patch :update, id: @discount, discount: { company_id: @discount.company_id, default: @discount.default, description: @discount.description, discount: @discount.discount }
    assert_redirected_to discount_path(assigns(:discount))
  end
