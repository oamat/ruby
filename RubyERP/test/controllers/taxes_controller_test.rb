...
class TaxesControllerTest < ActionController::TestCase
  ...
  test "should create tax" do
    assert_difference('Tax.count') do
      post :create, tax: { company_id: @tax.company_id, default: @tax.default, description: @tax.description, tax: @tax.tax }
    end
  ...
  test "should update tax" do
    patch :update, id: @tax, tax: { company_id: @tax.company_id, default: @tax.default, description: @tax.description, tax: @tax.tax }
    assert_redirected_to tax_path(assigns(:tax))
  end
